...
/**
 * Clé S3 : [dev/][NomDossier/.../]uuid-fichier.ext
 * STORAGE_KEY_PREFIX isole le local dans le même bucket (ex. "dev").
 */
export function buildObjectKey({ folderPath = [], fileName }) {
  ...
  return withStorageKeyPrefix(parts.join("/"));
}
